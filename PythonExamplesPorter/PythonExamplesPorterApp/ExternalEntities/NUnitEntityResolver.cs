        ...
        private OperationResult<MemberResolveData> ResolveAreEqualMethod(MemberData data, MemberRepresentation representation)
        {
            ...
            switch (data.Arguments.Count)
            {
                case 2:
                    ...
                    {
                        true => GenerateMethodCall("assertSequenceEqual", new []{arg0, arg1}, emptyNamedArgs),
                        false => GenerateMethodCall("assertEqual", new []{arg0, arg1}, emptyNamedArgs)
                    };
                case 3:
                    ...
                    return GenerateMethodCall(methodName, new []{arg0, arg1}, namedArgs);
            }
